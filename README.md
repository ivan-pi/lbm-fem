...
| `tools/` | `elem.cc`: element matrices from deal.II `FEValues`, to check against `analysis/stencils.py`; `mass_preconditioners.cc`: spectra and CG convergence of the mass solves |
